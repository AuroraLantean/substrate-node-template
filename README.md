...
add_user
set reward_rate per 1000 per sec: 100 as 10% per sec
stake 1000
unstake
withdraw
...
> [genesis state](https://github.com/AuroraLantean/substrate-node-templateblob/main/node/src/chain_spec.rs#L49).
